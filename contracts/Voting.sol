...
function voterRight(
    ...
    string memory_ipfs
        ...
        require(
            votingOrganizer == msg.sender, 
            "Only organizer can authorize voter"
    );
    _voterId.increment();
    uint256 idNumber = _voterId.current();
    Voter storage voter = voters[_address];
    require(voter.voter_voterId == 0, "Voter already exist");
...
function getVoter() public view returns(uint256){
